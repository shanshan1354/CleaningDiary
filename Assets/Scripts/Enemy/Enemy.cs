...
public class Enemy : MonoBehaviour
{
    ...
    //属性
    protected bool follow;//敌人是否处于跟随状态
    public float speed;
    public float HP;
    public int reward;//通关奖励的金钱
    protected RaycastHit2D hit;
    protected float curHP;//当前血量
    protected LayerMask layerMask;
    public bool isBoss;

    //资源
    public GameObject[] bloodGos;//血迹
    public GameObject bloodDeadGo;//死亡血迹
    ...
    protected void SearchAndFollowPlayer()
    {
        ...
        {
            if (!hit.collider.CompareTag("Wall"))//看见玩家
            {
